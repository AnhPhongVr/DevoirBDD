...
{ ?>
    <p>L'acteur <?php echo $donnees['acteur']; ?> joue dans le film <?php echo $donnees['titre']; ?> projeté dans le cinema <?php echo $donnees['nomCinema']; ?> dans le salle <?php echo $donnees['idSalle']; ?> qui appartient à l'entreprise <?php echo $donnees['nom']; ?> à <?php $donnees['ville']?></p>
<?php
}
$req->closeCursor();
?>
